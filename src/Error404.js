...
function Error404() {
  return (
    <div className="text-center" style={{paddingTop:"150px", paddingBottom:"50px"}}>
        <svg style={{ color: "#b7996c" }} className="bi bi-exclamation-triangle" width="4em" height="4em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
