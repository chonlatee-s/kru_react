...
import smHome6 from './img/smHome6.jpg';
    ...
    return (
        <Container className="boxTutorial">
            ...
            <Row className="justify-content-center" style={{paddingTop:"50px"}}>
                ...
                <Col lg="auto" className="mb-4">
                    <Card style={{ width: '14rem' }}>
                        <Card.Img variant="top" src={smHome6} />
                        <Card.Body>
                            <Card.Text>ออกแบบเอกสารสัมภาษณ์ครูผู้ช่วย</Card.Text>
                            <svg style={{color:"#28a745"}} className="bi bi-pencil-square" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15.502 1.94a.5.5 0 010 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 01.707 0l1.293 1.293zm-1.75 2.456l-2-2L4.939 9.21a.5.5 0 00-.121.196l-.805 2.414a.25.25 0 00.316.316l2.414-.805a.5.5 0 00.196-.12l6.813-6.814z"/>
                            <path fillRule="evenodd" d="M1 13.5A1.5 1.5 0 002.5 15h11a1.5 1.5 0 001.5-1.5v-6a.5.5 0 00-1 0v6a.5.5 0 01-.5.5h-11a.5.5 0 01-.5-.5v-11a.5.5 0 01.5-.5H9a.5.5 0 000-1H2.5A1.5 1.5 0 001 2.5v11z" clipRule="evenodd"/>
                            </svg> <span style={{fontSize:"16px", fontWeight:300,color:"#28a745", cursor:"pointer"}}><a href="https://www.youtube.com/watch?v=BXT4kLcIS48&list=PL91Isj7zXY5x_Yt6c5ozOtL2tPLwcK1DN" target="_blank" rel="noopener noreferrer">เข้าสู่บทเรียน</a></span>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
