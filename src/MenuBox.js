            ...
            <div className="row text-center">
                <div className="col-sm">
                    <Link to="professional">
                        <svg style={{ color: "#b7996c" }} className="bi bi-clipboard-data" width="3em" height="3em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-sm">
                    <Link to="tutorial">
                        <svg style={{ color: "#b7996c" }} className="bi bi-pencil-square" width="3em" height="3em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-sm">
                    <svg style={{ color: "#b7996c" }} className="bi bi-people-circle text-center" width="3em" height="3em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
