      ...
      <Container className="boxHow">
        ...
        <Row className="text-center">
          <Col xs="12" style={{paddingTop:"10px"}}>
            <a className="btn btn-outline-success btnFull" target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/17GMXt-uu8VCnVwhEPZObx1dIKRB5ODWV/view?fbclid=IwAR1BZ131EanvC79qJakVeHn24nPOuUSuOZGlWn6EmmW_9xUUBp3DGn3CAjg">อ่านรายละเอียดทั้งหมด</a>
          </Col>
        </Row>
      </Container>
  );
